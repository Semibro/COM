...
from .serializers import MovieListSerializer, ReviewSerializer, DetailSerializer, CreditSerializer
...
@api_view(['GET', 'POST'])
def movie_credit(request, movie_pk):
    pass
    # Credit
...
#     saved_movies = Detail.objects.values_list('id', flat=True)
...
@api_view(['GET', 'POST'])
def movie_recommend(reqeust, movie_pk):
    pass
#     popular_url = f"https://api.themoviedb.org/3/movie/{movie_pk}/recommendations?language=ko-KR&page=1"
...
#                 except:
#                     pass
#     movies = get_list_or_404(Recommend)
#     serializer = MovieListSerializer(movies, many=True)
#     return Response(serializer.data)
